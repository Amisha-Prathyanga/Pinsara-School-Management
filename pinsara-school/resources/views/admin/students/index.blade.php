...
@section('content')
                    ...
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
                            <table class="table">
                                <thead>
                                    <tr>
                                        <th>#</th><th>Name</th><th>Email</th><th>Address</th><th>Actions</th>
                                    </tr>
                                </thead>
                                <tbody>
    ...
    <div class="row align-items-center">
        <div class="col-md-6">
            <div class="mb-3">
                <h5 class="card-title">Student List <span class="text-muted fw-normal ms-2">({{$stdc}})</span></h5>
            </div>
        </div>
        <div class="col-md-6">
            <div class="d-flex flex-wrap align-items-center justify-content-end gap-2 mb-3">
                ...
                <div>
                    <a href="{{ url('/admin/students/create') }}" data-bs-toggle="modal" data-bs-target=".add-new" class="btn btn-primary"><i class="bx bx-plus me-1"></i> Add New</a>
                </div>
                            ...
                            <td>{{ $item->address }}</td>
                                ...
                                <td>
                                    ...
                                    <li class="list-inline-item">
                                            <a href="{{ url('/admin/students/' . $item->id) }}" data-bs-toggle="tooltip" data-bs-placement="top" title="View" class="px-2 text-primary"><i class="bx bx-carousel font-size-25"></i></a>
                                        </li>
                                        <li class="list-inline-item">
                                            <a href="{{ url('/admin/students/' . $item->id . '/edit') }}" data-bs-toggle="tooltip" data-bs-placement="top" title="Edit" class="px-2 text-warning"><i class="bx bx-pencil font-size-25"></i></a>
                                        </li>
                                        <li class="list-inline-item">
                                        <form method="POST" action="{{ url('/admin/students' . '/' . $item->id) }}" accept-charset="UTF-8">
                                                {{ method_field('DELETE') }}
                                                {{ csrf_field() }}

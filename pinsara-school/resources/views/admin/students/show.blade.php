        ...
        <div class="row">
            ...
            <div class="col-md-9">
                <div class="card" style="margin-top: 20px">
                    <div class="card-header" style="background-color: rgb(248 250 252)">Student {{ $student->id }}</div>
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
                            <table class="table">
                                <tbody>
                                    ...
                                    <tr><th> Name </th><td> {{ $student->name }} </td></tr><tr><th> Email </th><td> {{ $student->email }} </td></tr><tr><th> Address </th><td> {{ $student->address }} </td></tr>
                                </tbody>
                            </table>
                        </div>
